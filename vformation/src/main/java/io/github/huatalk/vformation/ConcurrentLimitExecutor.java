 ...
 */
class ConcurrentLimitExecutor<V> {
    ...
    ConcurrentLimitExecutor(ListeningExecutorService pool, ParOptions options, ListeningExecutorService submitterPool) {
     ...
     */
    static <V> ConcurrentLimitExecutor<V> create(ListeningExecutorService pool, ParOptions options, ListeningExecutorService submitterPool) {
     ...
     */
    AsyncBatchResult<V> submitAll(List<? extends Callable<V>> tasks) {
        if (tasks.isEmpty()) {
