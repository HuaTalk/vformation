...
import static io.github.huatalk.vformation.CancellationTokenState.FAIL_FAST_CANCELED;
import static io.github.huatalk.vformation.CancellationTokenState.MUTUAL_CANCELED;
import static io.github.huatalk.vformation.CancellationTokenState.PROPAGATING_CANCELED;
import static io.github.huatalk.vformation.CancellationTokenState.RUNNING;
import static io.github.huatalk.vformation.CancellationTokenState.SUCCESS;
import static io.github.huatalk.vformation.CancellationTokenState.TIMEOUT_CANCELED;
...
public class CancellationToken {
    ...
    <T> void lateBind(List<ListenableFuture<T>> futures, Duration timeout, ListenableFuture<?> submitCanceller) {
        if (parent != null) {
